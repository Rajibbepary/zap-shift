...
const ClientTestominal = () => {
    return (
        <div className="w-11/12 mx-auto mt-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#03373D]">What our customers are sayings</h1>
            <p className="text-sm w-9/12 mx-auto md:text-base text-gray-500 mt-4">Enhance posture, mobility, and well-being effortlessly with Posture Pro. Achieve proper alignment, reduce pain, and strengthen your body with ease!</p>
            <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
                <div className="w-80 flex flex-col items-start border border-gray-200 dark:border-gray-800 p-5 rounded-lg bg-white dark:bg-gray-800">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-gray-500 font-medium">Donald Jackman</h2>
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 dark:border-gray-800 p-5 rounded-lg bg-white dark:bg-gray-800">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-gray-500 font-medium">Richard Nelson</h2>
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 dark:border-gray-800 p-5 rounded-lg bg-white dark:bg-gray-800">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-gray-500 font-medium">James Washington</h2>
...
export default ClientTestominal;